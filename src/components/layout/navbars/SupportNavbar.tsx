    ...
    <nav className="sticky top-0 z-40 bg-white/70 dark:bg-black/40 backdrop-blur-2xl backdrop-saturate-150 border-b border-white/30 dark:border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
      <div className="flex items-center justify-between h-16 px-4 md:px-6">
              ...
              <SheetHeader className="p-4 border-b border-orange-400/20">
                <SheetTitle className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-orange-200">Support Hub</p>
                  </div>
                </SheetTitle>
              </SheetHeader>
              ...
              <div className="p-4 border-b border-orange-400/20">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div className="overflow-hidden">
                    <p className="font-medium text-white truncate">{profile?.full_name || user?.email?.split('@')[0] || 'Agent'}</p>
                ...
                <div className="grid grid-cols-3 gap-2 mt-3">
                  <div className="bg-orange-500/10 rounded-lg p-2 text-center">
                    ...
                    <p className="text-[10px] text-orange-200">Open</p>
                  </div>
                  <div className="bg-orange-500/10 rounded-lg p-2 text-center">
                    <p className="text-sm font-bold text-white">48</p>
                    <p className="text-[10px] text-orange-200">Resolved</p>
                  </div>
                  <div className="bg-orange-500/10 rounded-lg p-2 text-center">
        ...
        <div className="hidden md:flex items-center">
          <span className="text-lg font-display font-bold text-foreground">Support Hub</span>
        </div>
