      ...
      <nav className="sticky top-0 z-40 bg-gradient-to-r from-orange-300/95 via-amber-200/95 to-orange-300/95 backdrop-blur-lg border-b border-orange-400/30">
        <div className="flex items-center justify-between h-16 px-4 md:px-6">
          ...
          <button
            ...
            className="hidden lg:flex flex-1 max-w-md mx-4 items-center gap-2 px-3 h-10 rounded-md bg-white/60 border border-orange-400 text-orange-500 hover:bg-white/80 transition-colors cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <Button
              variant="ghost"
              size="icon"
              className="lg:hidden h-9 w-9 text-orange-800 hover:bg-orange-400/30"
              onClick={() => setSearchOpen(true)}
            >
